          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<p><em>(Please send your BTC to the above address to get corresponding VCN coins and mention the transaction information.)</em></p>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="number" id="BTCamount" name="amount" class="form-control col-md-7 col-xs-12" min="0" onkeyup="compareamt();" onkeypress="return isNumberKey(event)">
                            </div>
                          </div>


                         <div id="ratetxt" class="btn btn-success"> Total VCN Receive : <span id="rate"></span> VCN</div>
