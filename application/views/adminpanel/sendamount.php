        ...
        <?php } ?>
                    <form action="<?php echo admin_url()?>sendamount/transferamount" method="POST" id="sendform" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="amount" name="amount" class="form-control validate[required,custom[number],min[0.01]] col-md-7 col-xs-12" value="" onkeypress="return isNumberKey(event)">
                        </div>
                      </div>
                    <!--  <div class="form-group">
