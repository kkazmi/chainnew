          ...
          foreach($detail as $transaction)
            {
            	...
            	$data .='<tr>';
                 ...
                 {
						  $data .='<a class="btn btn-sm btn-success" title="User Account unblock" href="#"  onclick="userenabledisable(\''.$transaction->id.'\',1);"><i class="fa fa-eye"></i></a>';
                  }else{
              $data .='<a class="btn btn-sm btn-danger" title="User Account block" href="#" onclick="userenabledisable(\''.$transaction->id.'\',0);"><i class="fa fa-eye-slash"></i></a>';
                  }


                 if($transaction->tfa_status=='0')
                 {
              $data .='<a class="btn btn-sm btn-success" title="User  Two factor Authentication unblock  "  href="#" onclick="usertfaenabledisable(\''.$transaction->id.'\',1);"><i class="fa fa-lock"></i></a>';
                  }else{
              $data .='<a class="btn btn-sm btn-danger" title="User  Two factor Authentication block  "  href="#" onclick="usertfaenabledisable(\''.$transaction->id.'\',0);"><i class="fa fa-unlock"></i></a>';
                  }


              $data .='<a class="btn btn-sm btn-warning" title="User Transactions details " href="#" onclick="usertransactionlist(\''.$transaction->email.'\');" data-toggle="modal" data-target="#myModal"><i class="fa fa-file-text"></i></a>';
